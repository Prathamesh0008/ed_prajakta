...
//                     value={searchQuery}
//                     onChange={handleSearchChange}
//                     className="w-36 lg:w-48 xl:w-64 pl-9 pr-3 py-2 sm:pl-10 sm:pr-4 sm:py-2.5 bg-white border border-gray-200 rounded-full focus:outline-none focus:ring-2 focus:ring-[#8B0035]/30 focus:border-[#8B0035] text-sm text-black"
//                   />
//                   <Search className="absolute left-3 top-1/2 transform -translate-y-1/2 w-3.5 h-3.5 sm:w-4 sm:h-4 text-gray-400" />
                  
//                   {/* Desktop Search Results */}
//                   {filteredProducts.length > 0 && (
//                     <div className="absolute top-full left-0 mt-2 w-full bg-white border border-gray-200 rounded-xl shadow-lg z-50 max-h-72 overflow-auto">
//                       {filteredProducts.slice(0, 6).map((product) => (
//                         <Link
//                           key={product.slug}
//                           href={`/products/${product.slug}`}
